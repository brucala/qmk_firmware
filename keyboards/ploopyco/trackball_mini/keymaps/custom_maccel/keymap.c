...
enum td_keycodes {
    ...
    MSE_BTN5_DRAG_SCROLL_ACC  // Forward mouse button on tap, drag scroll on held, enable/disable acceleration on double tap
};
...
tap_dance_action_t tap_dance_actions[] = {
    //[MSE_BTN4_DPI] = ACTION_TAP_DANCE_DOUBLE(KC_BTN4, DPI_CONFIG), //doesn't seem to work
    [MSE_BTN4_DPI] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, mseBtn4_finished, mseBtn4_reset),
    [MSE_BTN5_DRAG_SCROLL_ACC]  = ACTION_TAP_DANCE_FN_ADVANCED(NULL, mseBtn5_finished, mseBtn5_reset)
};